<?php 
/* 
    Les headers des requêtes http permettent d'indiquer au navigateur ou au serveur des infos avant de lire un fichier 
    Par exemple, quel est le type de ce fichier, quel est le code d'état de la requête (200, 301, 404 ...)
...
if (rand(0,100) < 50) {
    ...
    /* 
        ...
        Ceux-ci mettent fin à l'execution de tout code, afin d'être sûr que rien ne se soit passé avant de rediriger 
...
$title = "Gestion des headers de requête";
require  __DIR__. "/../ressources/template/_header.php";
// Sans paramètre, affihce le code de la page :
