...
function changeTheme() {
   ...
   if(dark.checked) {
    ...
    /*
        Je sauvegarde une valeur (string) en localStorage à la clef "theme".
    */
    ...
    /*
        Je retire ma valeur sauvegardé à la clef "theme"
    */
...
/*
    ...
    Ils utilisent les mêmes méthodes l'un comme l'autre 
