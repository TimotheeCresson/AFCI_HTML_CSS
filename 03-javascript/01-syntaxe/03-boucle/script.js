...
/*
    ...
    - La seconde est une condition qui va être vérifié avant chaque itération
    - La troisième est une modification de la variable à la fin de chaque itération 
*/
for(let i =0; i<10; i++) {    
...
/*
    ...
    A chaque itération, la variable définie entre parenthèse se verra attribuer une nouvelle valeur.
...
/*
    ...
    Il ne fonctionnera pas avec les objets
*/
for (let f of arr){
...
/*
    ...
    forEach va produire une boucle pour chaque élément du tableau, à chaque boucle, il appellera la fonction donnée en paramètre et placera l'élément du tableau en paramètre de cette fonction. Si on donne un second paramètre à la fonction, il pourra aussi récupérer l'index.
*/
...
/*
    ...
    De même que pour forEach, il va bouclé sur chaque élément du tableau.
