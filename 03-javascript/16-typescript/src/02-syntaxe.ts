...
const arr1: string[] = ["truc", "bidule" /*54*/]; // on doit mettre que des strings sinon ne fonctionne pas 
/*
    Dans de rare cas, une variable doit pouvoir contenir n'impote quel type de valeur 
    On utilisera alsor le mot clef "any"
*/
let truc: any = 5;  // peut contenir n'impote quoi
truc = "bidule";
const arr2: any[] = ["truc", 45, true]; // le tableau peut contenir n'importe quoi grâce à any
/*
...
*/
const person: {prenom: string, age?: number} = {prenom: "Maurice"}; // person est un objet qui doit contenir un prenom qui est un string et possiblement un age qui est un nombre
...
*/
const salut: Function = function(){}; // si salut est une fonction faire fonction
/*
...
*/
function tri(arg:readonly any[]): any[] { // l'argument est un tableau, on ne pourra pas le modifié, seul un return plus création copie fonctionne
